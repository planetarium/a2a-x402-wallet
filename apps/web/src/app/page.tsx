  ...
  return (
    <div className="relative min-h-screen bg-zinc-950 text-zinc-50 flex flex-col">
      ...
      <main className="relative z-10 flex-1 flex flex-col items-center px-6 pt-16 pb-24">
        ...
        <Link
          href="/docs"
          className="group mt-4 flex items-center justify-between w-full max-w-2xl rounded-xl border border-zinc-800 bg-zinc-900/50 px-5 py-4 hover:border-zinc-600 hover:bg-zinc-900 transition-colors"
        >
          <div>

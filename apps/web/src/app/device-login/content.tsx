...
import {
  ...
  Code, CopyButton, LoginSkeleton, DelegationModal,
} from '@/components/ui';
      ...
      <CenteredShell>
        ...
        <Card>
          <p className="text-sm text-red-400">
            Missing session parameter. Please run{' '}
            ...
            <div className="flex flex-col items-center gap-3 py-2 text-center">
              ...
              {error ? (
                ...
                <div className="w-full">
                  <p className="text-sm font-semibold text-zinc-200">{done ? 'Authorized.' : 'Authorizing CLI...'}</p>
                  ...
                  {done && nonce && (
                    <div className="mt-4 text-left">
                      ...
                      <div className="flex items-center gap-2 rounded-lg bg-zinc-800/60 border border-zinc-700/50 px-3 py-2">
                        ...
                        <CopyButton
                          text={`a2a-wallet auth device poll --nonce ${nonce}`}
